...
import { FeaturesSectionDemo } from "./components/middle/background-boxes";
...
<h2 className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans">
  ...
  className="px-10 py-3 mt-12 pl-4 ml-36 mx-auto max-w-7xl text-xl md:text-5xl font-bold bg-blue-500 text-neutral-800 dark:text-neutral-200 font-sans rounded-lg hover:bg-blue-600 transition-colors"
